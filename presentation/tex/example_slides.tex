...
\titleimage{map_topo_dem2}

\title[Spatial Stock Assessment] % (optional, use only with long paper titles)
{A Sketch Of An Idea On Spatial Stock Assessment}

%\subtitle
%{Include Only If Paper Has a Subtitle}

\author[CP Millar] % (optional, use only with lots of authors)
{Colin P.~Millar}
% - Give the names in the same order as the appear in the paper.

\institute[JRC] % (optional, but mostly needed)
{European Commission - Joint Research Center}
% - Keep it simple, no one is interested in your street address.

\date[Sketch 2012] % (optional, should be abbreviation of conference name)
{Idea Sketch, March 2012}
